...
Version  : 1.2.2
Release  : 1
URL      : https://github.com/onnx/onnx/archive/v1.2.2.tar.gz
Source0  : https://github.com/onnx/onnx/archive/v1.2.2.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1532917685
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
