...
Version  : 1.8.1
Release  : 31
URL      : https://files.pythonhosted.org/packages/2b/8d/c924f54e19ec71543c18658d86e8337579d5a784bd524b7f18e2e2cd6f17/onnx-1.8.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/2b/8d/c924f54e19ec71543c18658d86e8337579d5a784bd524b7f18e2e2cd6f17/onnx-1.8.1.tar.gz
...
%prep
%setup -q -n onnx-1.8.1
cd %{_builddir}/onnx-1.8.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1611971661
...
cp %{_builddir}/onnx-1.8.1/LICENSE %{buildroot}/usr/share/package-licenses/onnx/72abeb57e64fb30074f90a0cf3238a35f63d8a6d
cp %{_builddir}/onnx-1.8.1/third_party/benchmark/LICENSE %{buildroot}/usr/share/package-licenses/onnx/2b8b815229aa8a61e483fb4ba0588b8b6c491890
cp %{_builddir}/onnx-1.8.1/third_party/pybind11/LICENSE %{buildroot}/usr/share/package-licenses/onnx/3dbd61e2b2c71dcc658c3da90bacf2e15958075a
