...
Version  : 1.16.2
Release  : 75
URL      : https://files.pythonhosted.org/packages/d8/83/09d7715612f72236b439eba6ebfecdaac59d99562dfc1d7a90dddb6168e1/onnx-1.16.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/d8/83/09d7715612f72236b439eba6ebfecdaac59d99562dfc1d7a90dddb6168e1/onnx-1.16.2.tar.gz
...
%prep
%setup -q -n onnx-1.16.2
cd %{_builddir}/onnx-1.16.2
pushd ..
cp -a onnx-1.16.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722526782
