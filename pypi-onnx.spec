...
Source0  : https://files.pythonhosted.org/packages/3d/60/e56e8ec44ed34006e6d4a73c92a04d9eea6163cc12440e35045aec069175/onnx-1.18.0.tar.gz
...
%prep
%setup -q -n onnx-1.18.0
cd %{_builddir}/onnx-1.18.0
pushd ..
cp -a onnx-1.18.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747235365
